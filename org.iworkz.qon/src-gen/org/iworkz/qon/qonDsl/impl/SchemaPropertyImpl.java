 ...
 * </p>
 * <ul>
 *   <li>{@link org.iworkz.qon.qonDsl.impl.SchemaPropertyImpl#getLink <em>Link</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchemaPropertyImpl extends QSystemPropertyImpl implements SchemaProperty
{
  /**
  ...
  {
    return QonDslPackage.Literals.SCHEMA_PROPERTY;
  }
    ...
    if (link != null && link.eIsProxy())
    {
      ...
      if (link != oldLink)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, QonDslPackage.SCHEMA_PROPERTY__LINK, oldLink, link));
      }
    }
    return link;
  }
  ...
  public void setLink(QObject newLink)
  {
    ...
    link = newLink;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, QonDslPackage.SCHEMA_PROPERTY__LINK, oldLink, link));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case QonDslPackage.SCHEMA_PROPERTY__LINK:
